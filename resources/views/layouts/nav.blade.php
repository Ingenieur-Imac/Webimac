...
<ul>
    ...
    <li><a href="{{ url('/realisations') }}" {{ Request::is('realisations/*') || Request::is('realisations') ? "class=active" : '' }}>Réalisations</a></li>
    <li><a href="{{ url('/nos-etudiants') }}" {{ Request::is('nos-etudiants') ? "class=active" : '' }}>Nos étudiants</a></li>
    <li><a href="{{ url('/vie-etudiante') }}" {{ Request::is('vie-etudiante') ? "class=active" : '' }}>Vie étudiante</a></li>
