...
@section('content')
    ...
    <div class="container">
        <div class="col-8 center-block">
            ...
            <p>Les étudiants de l'IMAC bénéficient ainsi de nombreuses associations pour y pratiquer de la musique, créer des événements tout en sirotant une menthe à l'eau. Vous pouvez vous rendre <a href="http://www.u-pem.fr/vie-du-campus/vie-associative-et-culturelle/associations-etudiantes-a-lupem/" target="_blank">sur la page dédiée du site de l'UPEM</a> pour plus d'informations. Voici quelques associations :</p>
        </div>
    </div>
