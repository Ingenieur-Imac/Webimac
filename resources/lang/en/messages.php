...
*/
    ...
    return [
        ...
        "op-ctn-c-1-t" => "After IMAC",
        "op-ctn-c-1-st" => "IMAC engineers are highly regarded for their expertise and their unique versatility in the arts and sciences.",
        "op-ctn-c-1-c" => "Their immersion in the professional world and their exchanges both with technicians and designers are greatly facilitated. Internships and various team projects allow them to incorporate the codes and reactions of the workplace.",
            //THREE BLOCK SYSTEM
        "op-ctn-c-2-t" => "95%",
        "op-ctn-c-2-st" => "of hires",
        "op-ctn-c-2-c" => "after 6 months ; the remaining 5% are studying",
        "op-ctn-c-3-t" => "+∞",
        "op-ctn-c-3-st" => "jobs",
        "op-ctn-c-3-c" => "in the fields of Arts and Sciences",
        "op-ctn-c-4-t" => "31K€",
        "op-ctn-c-4-st" => "average first-job salary",
        "op-ctn-c-4-c" => "the wage is equivalent to the high demand",
            //TAGS SYSTEM
        ...
        "ptn-ctn-t" => "Partners",
        "ptn-ctn-st" => "Incorporated into the business world, IMAC has relationship with majors players of multimedia.",
        "ptn-ctn-c" => "",
        ...
        "prs-ctn-t" => "What is IMAC ?",
        "prs-ctn-st" => "IMAC is an engineering training certified by <a href='http://www.cti-commission.fr/' target='_blank' > CTI </a> (Commission des Titres d’Ingénieur). Created in 1986, it’s the only French public engineering programme mixing art and technology.",
        "prs-ctn-c" => "We train students to become seniors executives in multiple fields: the web, video games, audiovisual or digital communication.  ",
        ...
        "sl-ctn-t" => "Student life on campus",
        "sl-ctn-st" => "The Union activity on campus as well as conferences and artistic, cultural workshops are strong points that UPEM (Université Paris-Est Marne-la-vallée) advocates and values ​​.",
        "sl-ctn-c" => "IMAC are invited to join many societies to enjoy a wide variety of activities, practice music, create events while sipping a mint water. You can visit the dedicated page on <a href='http://www.u-pem.fr/vie-du-campus/vie-associative-et-culturelle/associations-etudiantes-a-lupem/' target='_blank'> UPEM 's website</a> for more information",
             //ASSOCIATIONS LIST
         "sl-ctn-2-a-1-t" => "BDI",
         ...
         "sl-ctn-2-a-2-loc" => "Bâtiment Copernic",
         ...
         "sl-ctn-2-a-3-loc" => "Student House",
         ...
         "sl-ctn-2-a-5-loc" => "Down the hall of the first floor  - Bâtiment Copernic",
         ...
         "sl-ctn-2-a-6-loc" => "Student House",
        ...
        "sts-ctn-t" => "Who are IMAC students ?",
        "sts-ctn-st" => "A wide variety of personalities, caring, fun: IMAC is like a second family where gender parity is key ! With more than fifty students promotions links in the community get created in a very natural way.",
        "sts-ctn-c-1" => "Throughout the year, <a href='http://bde.ingenieur-imac.fr/' target='_blank'>the student union (BDI)</a> aims to cultivate this friendly spirit by organizing many events, including the must-attend JeudIMAC, convivial evenings with a drink in Paris. It also gives the opportunity to meet people or expand your address book as alumnis, but above all: have a good time !",
        "sts-ctn-c-2" => "At the time of the midyear exam, as specialists of an area will help others, you will find assistance if you seek it and see the heterogeneity of the recruitement proves to be beneficial to all. Welcome to IMAC !",
