...
*/
    ...
    return [
        ...
        "faq-ctn-a5" => "<p>En général, il y a environs 45 à 50 étudiants par promotion.",
        "faq-ctn-q6" => "Quelle formation faut-il suivre pour intégrer l'IMAC&nbsp;?",
        "faq-ctn-a6" => "<p>Il n'y a pas de formation précise pour intégrer l'IMAC. En effet, nous recrutons des étudiants de divers univers: scientifiques (prépa, licenses math-infos, DUT info...), artistiques (BTS audiovisuel, école d'art ou de cinéma...) ou encore des deux (DUT MMI).",
        ...
        "faq-ctn-q8" => "Qu'est-ce que je dois mettre dans mon portfolio exactement&nbsp;?",
