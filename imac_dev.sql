...
-- Generation Time: Jan 28, 2016 at 12:34 PM
...
(7, NULL, 'Carnet ', 'L‘application Carnet est le fruit de la première collaboration entre La Poste et l‘IMAC. Elle s‘inscrit dans le cadre du projet Factéo qui vise à fournir un smartphone aux plus de 100.000 facteurs en France d‘ici 2015. On retrouve l‘idée du carnet de rout', 'L‘application Carnet est le fruit de la première collaboration entre La Poste et l‘IMAC.', '2013-07-19 20:00:00', 'Pierre Criulanscy<br/>Hugo Gresse<br/>Pierre Guilloux<br/>Julie Pronzac', 'Benjamin Liger<br/>Ségolène Naline', '', 'carnet', 'carnet_Laposte.png', 'vimeo', '65968243', '', '', ''),
...
(11, NULL, 'Azheugaga - hypnotic cubes', 'Azheugaga est un projet de cinématique non-interactive inspiré du mythe biblique de Moïse ouvrant la mer rouge. Initialement prévu pour être seulement esthétique, la technique a été poussée afin d’afficher une scène constituée de nombreuses informations e', '', '2016-01-26 22:00:00', ' Rémi Génin', '', '', 'azheugaga-hypnotic-cubes', 'hypnotic.png', 'vimeo', '33841745', '', '', ''),
(12, NULL, 'Cloud Fighter', 'Cloud Fighter est un jeu en 2D sur Android. A l’aide de nuages qui émettent divers projectiles, vous devez viser des ennemis qui passent de droite à gauche de l’écran. Le but est de survivre et de détruire l’usine ennemie qui se situe à la fin de chaque n', 'Cloud Fighter est un jeu en 2D sur Android. ', '2016-01-28 10:02:01', 'Céline COGNY<br/>Stéphanie LUU<br/>Gabriel PEYROT', 'Anthony GIROUD', '', 'cloud-fighter', 'cloud_Fighter.png', 'dailymotion', 'ximp71', '', '', ''),
...
(1, 'Julie Pronzac', 'UX designer chez Nealite', 2014, 'L''IMAC m''a apporté une large culture numérique ainsi que l''ouverture d''esprit nécessaire pour m''orienter vers le métier de designer d''expérience. Être ingénieur créatif est un vrai plus dans ces métiers qui mêlent les compétences. Je recommanderais cette ', 'julie-pronzac.png'),
(2, 'Thibaut Dumont ', 'Ingénieur R&D reconnaissance musicale chez MyMusicTeacher', 0, 'Après avoir terminé mon cursus par une année d''échange et un stage de recherche en Corée du sud, j''ai rejoint une jeune startup sur le développement d''un jeu vidéo d''apprentissage de la guitare. Mes travaux s''étendent aujourd''hui du game-design au traitem', 'Thibaut-Dumont.png'),
(3, 'Marie Fétiveau', 'Lead Software Developer, RodeoFX, Montréal', 0, 'L''IMAC est une des rares formations à concilier sciences de l''ingénieur et arts. Ces trois années d''école m''ont permis d''acquérir des bases solides au travers des cours et des divers projets inter-diplômes, mais aussi de diversifier ma culture aussi bien ', 'Marie_Fétiveau.jpg'),
(4, 'Valentin Bourgoin', 'Directeur Technique chez 909c', 0, 'Je recommanderais l''IMAC car c''est important, dans le monde professionnel d''aujourd''hui, d''avoir plusieurs cordes à son arc et de savoir sans cesse évoluer. La pluridisciplinarité de l''IMAC permet à ses diplômés de posséder, en plus d''un certain savoir fa', 'Valentin_Bourgoin.jpg'),
(5, 'Sanaa Belkouch', 'Chef de projet digital', 0, 'Je recommande l''IMAC à toute personne qui aime créer, qui s''intéresse à la fois à l''art et aux nouvelles technologies. Apprenez à coder même si, à priori, ce n''est pas ce qui vous fait vibrer. Car cela vous ouvrira plusieurs perspectives. Pensez à l''entre', 'Sana_ Belkouch.jpg'),
